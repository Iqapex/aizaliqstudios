    ...
    <div className="dashboard">
      ...
      <div className="group">
        ...
        <div className="group-items">
          <div className="group-item" onClick={() => navigate("/interview/domain")}>
            Domain Specific Interview
          </div>
          <div className="group-item" onClick={() => navigate("/interview/competency")}>
            Competency Based Interview
          </div>
          <div className="group-item" onClick={() => navigate("/interview/hr")}>
            HR Interview
          </div>
        </div>
      </div>
